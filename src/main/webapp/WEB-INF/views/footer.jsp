<%@ taglib prefix="orm" uri="http://www.springframework.org/tags/form" %>
<footer>
    <div id="contact" class="contact">
        <h2>Get in touch!</h2>
        <h3>Contact form</h3>
        <form:form method="post" action="/submitMessage" modelAttribute="messageDTO">
            ...
            <div class="form-group"><form:textarea rows="4" cols="50" path="message" placeholder="Message"/>
